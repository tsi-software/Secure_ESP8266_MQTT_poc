...
## Secure MQTT Client
Again, there are many tutorials on how to program the ESP8266 as an MQTT Client. But I did not come across a single source clearly describing how to program the ESP8266 as a **secure** MQTT Client. As a long time software engineer I know how important security is these days.
